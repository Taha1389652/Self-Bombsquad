...
class ModFilesManager:
    def __init__(s, source):
        ...
        tw(
            ...
            scale=0.9,
            position=(260, 280),  # ارتفاع تایتل روی 280
            h_align='center',
            color=(0, 1, 1)
        )
    ...
    def delete_file(s, file_path, file_name):
        ...
        # دکمه ضربدر - فقط بستن پنجره (با AR.swish)
        ...
        # دکمه Yes - حذف فایل و بستن پنجره
        bw(
            parent=confirm_win,
            label='🗑️ Yes',
            size=(100, 28),
        ...
        # دکمه Cancel - فقط بستن پنجره (با AR.swish)
        bw(
            parent=confirm_win,
            label='Cancel',
            size=(100, 28),
            position=(180, 25),
            on_activate_call=Call(AR.swish, confirm_win),  # استفاده از Call به جای lambda
            color=(0.4, 0.4, 0.6),
            textcolor=(1, 1, 1),
            text_scale=0.6
        )
    ...
    def delete_all_pyc(s):
        ...
        # دکمه Yes All - حذف فایل‌ها و بستن پنجره
        bw(
            parent=confirm_win,
            label='🗑️ Yes All',
            size=(100, 28),
